...
<main class="main">
    ...
    <div class="container">
      <div class="main-write">
        ...
        <h1 class="heading">Sửa Bài</h1>
        <form  action="{{route('client.post.update', $post->id)}}" class="main-write-form" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="main-write-form-element-item">
              ...
              <div class="main-write-form-element-item-input">
                ...
                <select name="is_outstanding" id="">
                  <option value="1" {{$post->is_outstanding ==  1 ? "selected" : ""}}>Có</option>
                  <option value="0" {{$post->is_outstanding ==  0 ? "selected" : ""}}>Không</option>
                </select>
              </div>
              <div class="main-write-form-element-item-input">
                <p>Từ khoá</p>
                <input type="text" name="meta_keywords" placeholder="Tag1, Tag2, Tag3..." value="{{$post->tags}}" />
              </div>
            </div>
          </div>
          <div class="main-write-form-element">
